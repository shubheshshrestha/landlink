    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('processing', 'Processing'), ('cancelled', 'Cancelled'), ('returned', 'Returned'), ('shipped', 'Shipped'), ('delivered', 'Delivered'), ('pending', 'Pending')], default='pending', max_length=20)),
